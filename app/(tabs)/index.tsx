      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.hero}>
          <View style={styles.heroTop}>
            <View>
              ...
              <Text style={styles.appSub}>CDM 2026 ⚽</Text>
            </View>
        ...
        <View style={styles.grid}>
          ...
          <ActionTile
            icon="⭐"
            label="Wishlist"
            sub={`${collection.getWishlist().length} stickers`}
            color={Colors.gold}
          ...
          <ActionTile
            icon="🔄"
            label="Doublons"
            sub={`${collection.getDupeKeys().length} cartes`}
            color={Colors.turf}
            onPress={() => router.push('/(tabs)/wishlist')}
          />
        </View>
